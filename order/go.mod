...
require (
	github.com/Daniil-Sakharov/RocketFactory/platform v0.0.0-20251027194006-bc19c71d2c4b
	github.com/Daniil-Sakharov/RocketFactory/shared v0.0.0-20251009064825-93dfd695675a
