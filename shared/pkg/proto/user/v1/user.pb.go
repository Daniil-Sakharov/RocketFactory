...
import (
	v1 "github.com/Daniil-Sakharov/RocketFactory/shared/pkg/proto/common/v1"
...
type RegisterRequest struct {
	...
	// Методы уведомлений (Telegram, Email, SMS и т.д.)
...
// GetUserResponse - Информация о пользователе
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\tuser_uuid\x18\x01 \x01(\tR\buserUuid\"\x88\x01\n" +
	"\x0fGetUserResponse\x12#\n" +
	"\x04user\x18\x01 \x01(\v2\x0f.common.v1.UserR\x04user\x12P\n" +
	...
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseB\x9f\x01\n" +
	"\vcom.user.v1B\tUserProtoP\x01ZHgithub.com/Daniil-Sakharov/RocketFactory/shared/pkg/proto/user/v1;userv1\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\x06proto3"
